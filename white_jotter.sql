...
MySQL - 8.0.17 : Database - white_jotter
*********************************************************************
*/
...
insert  into `admin_role_menu`(`id`,`rid`,`mid`) values (19,4,1),(20,4,2),(21,3,1),(22,3,2),(23,9,1),(24,9,2),(121,1,1),(122,1,2),(123,1,3),(124,1,6),(125,1,7),(126,1,4),(127,1,8),(128,1,9),(129,1,10),(130,1,5),(188,2,1),(189,2,2),(190,2,4),(191,2,8),(192,2,9),(193,2,10);
...
insert  into `admin_role_permission`(`id`,`rid`,`pid`) values (108,1,1),(109,1,2),(110,1,3),(139,2,3),(140,9,1),(141,9,2),(142,9,3);
...
insert  into `admin_user_role`(`id`,`uid`,`rid`) values (1,2,2),(2,3,1),(3,4,9),(4,5,3);
...
insert  into `jotter_article`(`id`,`article_title`,`article_content_html`,`article_content_md`,`article_abstract`,`article_cover`,`article_date`) values (1,'test',NULL,NULL,NULL,NULL,NULL);
...
insert  into `user`(`id`,`username`,`password`,`salt`,`name`,`enabled`) values (2,'zhengjz','70af3663de97ab5f039281b90b0bb4a9','fcJWcsWppwZOKXd8hs2HwQ==','内容管理员',1),(3,'admin','dc101ee44421c77598e09b96d02b1dd9','FJVDsAR9dT9Yf9WuHFIGGQ==','系统管理员',1),(4,'test','ea4b17fa2303c734b331e41bea2e1c1e','0KXz6yqDVRxx13MPxF3qaQ==','测试角色',1),(5,'baomidi','ff7c127172960d70b83c966ef782ebdd','xFFKTncwbarLfpAUDb+VPA==','苞米地',1);
